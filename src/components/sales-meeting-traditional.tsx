...
// Static columns matching Source order
const INFO_COLS: Array<{
  ...
  // Source 對照碼與公式保留在 column description，不占用表頭。
              ...
              >
                ...
                {visibleInfoCols.map((col, i) => {
                  ...
                  if (col.type === 'warehouse') {
                    const warehouseGroup = col.key === 'mainStockPc' ? 'INTERNAL' : 'AUX';
                    const value = item[col.key as 'mainStockPc' | 'auxStockPc'];
