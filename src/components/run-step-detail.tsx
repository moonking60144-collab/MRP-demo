...
const WORK_ORDER_BOM_DETAIL_TIMING_LABELS = [
  ['work_order_bom_form28_fetch', 'Form 28 API'],
  ['work_order_bom_form28_insert', 'Form 28 寫入'],
  ['work_order_bom_form20_fetch', 'Form 20 API'],
          ...
          <table className="w-full text-[11px] border-separate border-spacing-0">
            ...
            <tbody>
              {items.map((item, index) => (
                <tr key={item.ragicRecordId || index} className="odd:bg-white even:bg-amber-50/40">
