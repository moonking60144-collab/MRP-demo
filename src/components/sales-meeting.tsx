              ...
              items.map((item, rowIndex) => {
                ...
                <Fragment key={item.id}>
                  ...
                  >
                    ...
                    {colVis.visibility['wfgStockPc'] !== false && (
                      <td data-col="wfgStockPc" data-value={String(item.wfgStockPc ?? '')} className="text-right font-mono text-xs">
                        <WarehouseStockValue
                    ...
                    {colVis.visibility['ye1StockPc'] !== false && (
                      <td data-col="ye1StockPc" data-value={String(item.ye1StockPc ?? '')} className="text-right font-mono text-xs">
                        <WarehouseStockValue
                          value={item.ye1StockPc}
                          warehouseGroup="YE1"
                          onOpen={() => openWarehouse(item, 'YE1')}
