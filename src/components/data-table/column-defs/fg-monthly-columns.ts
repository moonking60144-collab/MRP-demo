...
export const FG_MONTHLY_SIMPLE_COLUMNS: MrpColumnDef[] = [
  ...
  { id: 'mainStockPc', header: WAREHOUSE_STOCK_GROUPS.INTERNAL.label, filterType: 'numeric', align: 'right', mono: true },
  { id: 'auxStockPc', header: WAREHOUSE_STOCK_GROUPS.AUX.label, filterType: 'numeric', align: 'right', mono: true },
...
export const FG_TRAD_FROZEN: FgTradCol[] = [
  ...
  // Source 自由文字（如 "五彩三價,膜厚8μm,耐蝕72hr無白鏽…"），單行截斷
...
export const FG_TRAD_WAREHOUSE: FgTradCol[] = [
  { key: 'mainStockPc', label: WAREHOUSE_STOCK_GROUPS.INTERNAL.label, width: 120, filterType: 'numeric', align: 'right', mono: true, summable: true },
  { key: 'auxStockPc', label: WAREHOUSE_STOCK_GROUPS.AUX.label, width: 85, filterType: 'numeric', align: 'right', mono: true, summable: true },
];
