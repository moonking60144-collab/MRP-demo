...
const globalEvents = globalThis as unknown as { __demoWorkOrderEvents?: EventEmitter };
const emitter = globalEvents.__demoWorkOrderEvents
  ?? (globalEvents.__demoWorkOrderEvents = new EventEmitter());
