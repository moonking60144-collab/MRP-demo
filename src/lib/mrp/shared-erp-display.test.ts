...
test('實體庫存合計按 ERP 去重，但沒有 ERP 的列仍各自計算', () => {
  const total = sumPhysicalInventoryByErp([
    { erpPartNo: 'ERP-A', partVersion: 'A-1', currentStockPc: '600', wfgStockPc: '400', ye1StockPc: '150', badStockPc: '10' },
    { erpPartNo: 'ERP-A', partVersion: 'A-2', currentStockPc: '600', wfgStockPc: '400', ye1StockPc: '150', badStockPc: '10' },
    { erpPartNo: null, partVersion: 'B-1', currentStockPc: '25', wfgStockPc: '20', ye1StockPc: '5', badStockPc: '2' },
    { erpPartNo: null, partVersion: 'B-2', currentStockPc: '30', wfgStockPc: '10', ye1StockPc: '10', badStockPc: '3' },
  ]);
