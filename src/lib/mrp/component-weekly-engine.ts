 ...
 * Port of calculateMrpWeeklyProjection() from Ragic JS (d4_21 workflow, lines 811-1810)
 * Calculates a 27-week forward rolling stock projection plus a 前期 (W00)
 * bucket per material — matching Ragic's `for (i = 1; i <= 27; i++)` loop and
...
export async function calculateComponentWeekly(
  ...
  for (const materialNo of materials) {
    ...
    // Analytics — Ragic d4_21 line 1776 hardcodes the divisor as 28
