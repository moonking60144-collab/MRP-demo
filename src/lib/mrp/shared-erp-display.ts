...
export function sumPhysicalInventoryByErp<T extends SharedErpRow & {
  ...
  for (const row of rows) {
    ...
    stocks.set(key, {
      ...
      wfgStockPc: Number(row.wfgStockPc) || 0,
      ye1StockPc: Number(row.ye1StockPc) || 0,
  ...
  return [...stocks.values()].reduce(
    (total, stock) => ({
      ...
      wfgStockPc: total.wfgStockPc + stock.wfgStockPc,
      ye1StockPc: total.ye1StockPc + stock.ye1StockPc,
      badStockPc: total.badStockPc + stock.badStockPc,
    }),
    { currentStockPc: 0, wfgStockPc: 0, ye1StockPc: 0, badStockPc: 0 },
  );
}
