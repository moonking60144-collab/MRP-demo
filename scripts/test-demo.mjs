...
files.push('src/lib/archive/first-process-schema.test.ts', 'src/lib/sync/first-process-source.test.ts', 'src/lib/virtual-table-axis.test.ts', 'src/lib/virtual-table-rows.test.ts', 'src/lib/mrp/fg-monthly-selection.test.ts', 'src/components/data-table/column-header-contract.test.ts');
